...
export const sampleDevices = [
  ...
  // ============================================
  // DIGITAL DEVICES - TVs, CCTV DVRs, Biometric, etc. (1 device per license)
  ...
  {
    id: "dev040",
    deviceUserId: "TV_PG_001",  // Auto-generated device user ID
    deviceUserName: "Common Area TV",  // Auto-generated name (editable)
