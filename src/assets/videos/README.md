# Video Tutorial Files - RELOCATED

**⚠️ Important: This folder is no longer used for video files.**

Video files should now be placed in: **`public/assets/videos/`**

## Correct Location

Place your video tutorial files in **`public/assets/videos/`** (not here) with the following naming convention:
